        ...
        return `<div class="card" style="margin-bottom:12px">
          <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:10px">
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
              <b>${U.money(total)}</b>
              <button class="btn btn-ghost btn-sm" onclick="Views.orcamentos.addItem(${U.jsArg(pid)})"><i data-lucide="plus"></i>Categoria</button>
              <button class="btn btn-danger btn-sm" onclick="Views.orcamentos.removeProject(${U.jsArg(pid)})"><i data-lucide="trash-2"></i>Excluir orçamento</button>
            </div></div>
  ...
  editItem(id){
    ...
    UI.modal({ title:'Editar Custo Orçado', body:`
      <div class="form-grid">
        ...
        <div><label>Valor Orçado</label><input id="bg-value" type="number" step="0.01" value="${U.esc(b.value)}"></div>
      </div>`,
